        ...
        <div class="container mx-auto px-4">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="#contact-form" class="bg-green-600 text-white text-lg font-bold px-8 py-3 rounded-full text-center hover:bg-green-500 transition-colors">
                        Get Free Quote
                    </a>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-2xl mx-auto">
                ...
                <form method="post" class="space-y-6">
                    ...
                    <input type="hidden" name="ats_submit" value="1">
                    <button type="submit"
